...
function Home() {
  return (
    <Container id="home1" className="section">
      <Row className="d-flex justify-content-center align-items-center text-start">
        ...
        >
          <Row md={1} className="g-4">
            <Col>
              <a href="https://github.com/calKU0">
                <svg
                  width="32"
                  height="32"
            ...
            <Col>
              <a href="https://www.linkedin.com/in/krzysztof-kurowski-b26a282a3/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
            ...
            <Col>
              <a href="https://www.instagram.com/calku_/profilecard/?igsh=MXdkaWtnN2s3c25peA==">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
